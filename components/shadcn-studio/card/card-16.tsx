  ...
  return (
    <div className='h-max w-max'>
      <div className='spotlight-card group bg-border relative overflow-hidden rounded-xl p-px transition-all duration-300 ease-in-out'>
        <Card className='group-hover:bg-card/90 max-w-900 border-none transition-all duration-300 ease-in-out group-hover:backdrop-blur-[20px]'>
          <CardHeader>
            <CardTitle>Portofolio</CardTitle>
          </CardHeader>
          <CardContent>
            This is my portofolio. I'm a web developer and I'm passionate about creating beautiful and functional websites.
          </CardContent>
        </Card>
